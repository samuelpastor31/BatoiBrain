...
public class VistaIniciarSesionController implements Initializable {
    ...
    public VistaIniciarSesionController(UserRepository userRepository, Initializable controladorPadre, String vistaPadre,AnswerRepository answerRepository, QuestionRepository questionRepository,PartidaRepository partidaRepository) {
    ...
    public VistaIniciarSesionController(UserRepository userRepository) {
        this.userRepository = userRepository;
    }
    ...
    private void handleButtonLogIn(MouseEvent event, Users user) {
        try {
            ...
            VistaJuego vistaJuego = new VistaJuego(user, questionRepository, userRepository, answerRepository, 1,partida,partidaRepository);
